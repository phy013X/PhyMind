...
from model.model import MindConfig, MindForCausalLM  # MiniMind模型
...
class CriticModel(MindForCausalLM):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Mind PPO (Proximal Policy Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="Mind-PPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Mind-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
