...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Mind DPO (Direct Preference Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="Mind-DPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Mind-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
